...
3. Go to [Render](https://render.com/) and create an account. **Be sure to create your Render account with your Github login, then all your repos will be listed to quickly create a project**
4. Add a new "Web Service" and select this repo
